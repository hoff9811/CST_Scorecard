...
InputCard <- function(i_title, ...) {
  bs4Card(title = i_title,
          solidHeader = T,
          width = 6,
          height = 600,
          collapsible = F,
...
ScorecardInputs_ui <- function() {
  bs4Dash::tabsetPanel(id = "inputs", type = "tabs", vertical = FALSE,
    ...
    tabPanel(
      ...
      tags$br(),
      fluidRow(
        InputCard(" Project & Collateral Details:",
                  tags$br(),
                  shinyWidgets::autonumericInput(
                    inputId = "prop_val",
        ...
        InputCard("Additional Pledged Collateral Detail:",
                  tags$br(),
                  shinyWidgets::prettyRadioButtons(
    ...
    tabPanel(
      ...
      fluidRow(
        ...
        InputCard("Interest Reserve Details:",
                       tags$br(),
                       shinyWidgets::prettyRadioButtons(
                         inputId = "escrow_y_n",
    ...
    tabPanel(
      ...
      tags$br(),
      fluidRow(
        InputCard("Interest Rate Type Details:",
             tags$br(),
             shinyWidgets::prettyRadioButtons(
               inputId = "ir_type",
  ...
  InputCard("Interest Rate Details:",
         tags$br(),
